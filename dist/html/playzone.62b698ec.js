...
})({"4M5ty":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "a62d5e5a62b698ec";
"use strict";
...
},{}],"eZ1rF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/*--------------------------------Prey-------------------------------- */ parcelHelpers.export(exports, "Prey", ()=>Prey);
/*--------------------------------Move-------------------------------- */ parcelHelpers.export(exports, "MovePrey", ()=>MovePrey);
var _manager = require("./manager");
var _predator = require("./predator");
var _boar = require("./preys/Boar");
var _deer = require("./preys/Deer");
var _horse = require("./preys/Horse");
var _rabbit = require("./preys/Rabbit");
class Prey extends (0, _manager.Animal) {
    constructor(sex, row, col, type){
        super(sex, row, col, type);
    }
    static bornRabbit(randForSex, row, col, randForType) {
        if ((0, _manager.map)[row][col] === undefined) {
            let sex = "", child, type = "";
            randForSex == 1 ? sex = "woman" : randForSex == 2 ? sex = "man" : sex = undefined;
            randForType == 1 ? type = "rabbit" : type = undefined;
            child = new (0, _rabbit.Rabbit)(sex, row, col, type);
            preys.push(child);
        } else {
            row++;
            col++;
    ...
    static bornBoar(randForSex, row, col, randForType) {
        if ((0, _manager.map)[row][col] === undefined) {
            ...
            child = new (0, _boar.Boar)(sex, row, col, type);
            preys.push(child);
        } else {
            row++;
            col++;
    ...
    static bornDeer(randForSex, row, col, randForType) {
        if ((0, _manager.map)[row][col] === undefined) {
            ...
            child = new (0, _deer.Deer)(sex, row, col, type);
            preys.push(child);
        } else {
            row++;
            col++;
    ...
    static bornHorse(randForSex, row, col, randForType) {
        if ((0, _manager.map)[row][col] === undefined) {
            ...
            child = new (0, _horse.Horse)(sex, row, col, type);
            preys.push(child);
        } else {
            row++;
            col++;
    ...
    static die(x, y) {
        ...
        if ((0, _manager.map)[x][y]) {
            let obj = Object.assign({}, (0, _manager.map)[x][y]);
            let by_X = obj.row;
            let by_Y = obj.col;
        ...
        } else console.log(`No prey found at coordinates (${x}, ${y})`);
    }
    get allPreys() {
        return preys;
    }
...
class MovePrey extends Prey {
    ...
    static move() {
        ...
        while(flag != howMuchPreys){
            ...
            if (preys[k] == (0, _manager.map)[x][y]) switch(rand){
                case 1:
                    (0, _manager.map)[x][y] = undefined;
                    if (y >= 69) y -= 2;
                    y++;
                    if ((0, _manager.map)[x][y] !== undefined) {
                        y -= 2;
                        if (y >= 69) y -= 2;
                    }
                    MovePrey.bornAnAnimal(sex, x, y, type);
                    preys.shift();
                    (0, _manager.map)[x][y] = preys[thisIter];
                    flag++;
                    break;
                case 2:
                    (0, _manager.map)[x][y] = undefined;
...
},{"./manager":"fTnRZ","./predator":"g3Igi","./preys/Boar":"2DZou","./preys/Deer":"7tTOU","./preys/Horse":"iGzah","./preys/Rabbit":"iYvQ3","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4M5ty"], null, "parcelRequiref923")

//# sourceMappingURL=playzone.62b698ec.js.map
