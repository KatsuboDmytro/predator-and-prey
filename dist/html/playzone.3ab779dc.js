...
})({"2nD9Q":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "02da70f53ab779dc";
"use strict";
...
},{}],"g3Igi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/*--------------------------------Predator-------------------------------- */ parcelHelpers.export(exports, "Predator", ()=>Predator);
/*--------------------------------Move-------------------------------- */ parcelHelpers.export(exports, "MovePredator", ()=>MovePredator);
var _manager = require("./manager");
var _prey = require("./prey");
var _bear = require("./predators/Bear");
var _fox = require("./predators/Fox");
var _lynx = require("./predators/Lynx");
var _wolf = require("./predators/Wolf");
class Predator extends (0, _manager.Animal) {
    ...
    static bornFox(randForSex, row, col, randForType) {
        if ((0, _manager.map)[row][col] === undefined) {
            ...
            child = new (0, _fox.Fox)(sex, row, col, type);
    ...
    static bornBear(randForSex, row, col, randForType) {
        if ((0, _manager.map)[row][col] === undefined) {
            ...
            child = new (0, _bear.Bear)(sex, row, col, type);
            predators.push(child);
        } else {
            row++;
            col++;
    ...
    static bornLynx(randForSex, row, col, randForType) {
        if ((0, _manager.map)[row][col] === undefined) {
            ...
            child = new (0, _lynx.Lynx)(sex, row, col, type);
            predators.push(child);
        } else {
            row++;
            col++;
    ...
    static bornWolf(randForSex, row, col, randForType) {
        if ((0, _manager.map)[row][col] === undefined) {
            ...
            child = new (0, _wolf.Wolf)(sex, row, col, type);
            predators.push(child);
        } else {
            row++;
            col++;
...
class MovePredator extends Predator {
    ...
    static move() {
        ...
        while(flag != howMuchPredators){
            ...
            if (predators[k] == (0, _manager.map)[x][y]) switch(rand){
                case 1:
                    (0, _manager.map)[x][y] = undefined;
                    if (y >= 69) y -= 2;
                    y++;
                    if ((0, _manager.map)[x][y] instanceof (0, _prey.Prey)) (0, _prey.Prey).die(x, y);
                    if ((0, _manager.map)[x][y] instanceof Predator) {
                        y -= 2;
                        x += 1;
                        if (y >= 69) {
                            y -= 2;
                    ...
                    predators.shift();
                    (0, _manager.map)[x][y] = predators[thisIter];
                    flag++;
                    break;
                case 2:
                    (0, _manager.map)[x][y] = undefined;
...
},{"./manager":"fTnRZ","./prey":"eZ1rF","./predators/Bear":"bME0t","./predators/Fox":"7M6sq","./predators/Lynx":"hDx0G","./predators/Wolf":"3wd5t","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2nD9Q"], null, "parcelRequiref923")

//# sourceMappingURL=playzone.3ab779dc.js.map
